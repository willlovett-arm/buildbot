...
class Gerrit(Git):
    ...
    def startVC(self, branch, revision, patch):
        ...
        if (not self.sourcestamp or
            (self.sourcestamp.project != changed_project)):
            # If we don't have a sourcestamp, or that sourcestamp's project is
            # wrong, this isn't the repo that's changed.  Drop through and
            # check out the head of the given branch
            pass
